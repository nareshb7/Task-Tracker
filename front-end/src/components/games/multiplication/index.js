    ...
    return (
        <Container>
            <form class="form" id="form" onSubmit={handleSubmit}>
                ...
                <input type="text" className="input" id="input" value={userAns} placeholder="Enter your answer" onChange={(e) => setUserAns(e.target.value)} autofocus autocomplete="off"></input>
